...
namespace Handfire.Core
{
    public class HandfireUIMiddleware
    {
        ...
        public HandfireUIMiddleware(RequestDelegate next, IWebHostEnvironment hostingEnv, ILoggerFactory loggerFactory, HandfireUIOptions options)
        {
            _next = next;
        ...
        public static StaticFileMiddleware CreateStaticFileMiddleware(RequestDelegate next, IWebHostEnvironment hostingEnv, ILoggerFactory loggerFactory, HandfireUIOptions _options)
        {
