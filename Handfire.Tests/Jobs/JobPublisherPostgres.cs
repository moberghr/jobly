...
public class JobPublisherPostgres : PostgreSqlTestBase
{
    private readonly ITestOutputHelper _testOutputHelper;

    public JobPublisherPostgres(ITestOutputHelper testOutputHelper)
    {
    ...
    public async Task GetAndProcessJob_WithoutLockingInterceptor_CounterShouldBeMoreThenOne()
    {
        ...
        _testOutputHelper.WriteLine("Counter: " + counter);
