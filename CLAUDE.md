...
- Opt-in addons on the builder: `opt.AddRetry()`, `opt.AddConcurrency()` (Mutex + Semaphore), `opt.AddRateLimit()`, `opt.AddCircuitBreaker()`, `opt.AddNoRestart()`, `opt.UseDatabasePush()`
