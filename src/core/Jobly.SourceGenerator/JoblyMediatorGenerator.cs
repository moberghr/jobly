...
#pragma warning restore S3267
        ...
        if (requestTypes.Count == 0 && jobTypes.Count == 0)
        {
            return;
        }

        var source = GenerateSource(requestTypes, jobTypes);
    ...
    private static string GenerateSource(List<RequestTypeInfo> requestTypes, List<JobTypeInfo> jobTypes)
    {
        ...
        GenerateDIRegistration(sb, requestTypes, jobTypes);
    ...
    private static void GenerateDIRegistration(StringBuilder sb, List<RequestTypeInfo> requestTypes, List<JobTypeInfo> jobTypes)
    {
