...
public class OrchestrationTaskTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;

    public OrchestrationTaskTests(PostgreSqlFixture fixture) => _fixture = fixture;
    ...
    public async Task RunOrchestration_BatchAllChildrenCompleted_FinalizesBatch()
    {
        ...
        await OrchestrationTask<TestContext>.RunOrchestration(orchCtx, CancellationToken.None);
    ...
    public async Task RunOrchestration_ActivatesContinuationChildren()
    {
        ...
        await OrchestrationTask<TestContext>.RunOrchestration(orchCtx1, CancellationToken.None);
        var orchCtx2 = _fixture.CreateContext();
        await OrchestrationTask<TestContext>.RunOrchestration(orchCtx2, CancellationToken.None);
    ...
    public async Task RunOrchestration_AlreadyFinalized_ReturnsNoWork()
    {
        ...
        // Act
        var orchCtx = _fixture.CreateContext();
        var workDone = await OrchestrationTask<TestContext>.RunOrchestration(orchCtx, CancellationToken.None);
