...
public class InternalJobBuilder
{
    private InternalJobBuilder() { } // Hide the constructor

    public static InternalJobBuilder Create() // Expose a public static factory method
    {
        return new InternalJobBuilder();
    }
