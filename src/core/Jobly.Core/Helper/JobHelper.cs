...
{
    public static JobState CreateJobAndJobState<T>(T message, int retries, string name, DateTime? scheduleTime, Priority priority, int? maxRetries, string? parentId, State? state, string? batchId)
        where T : class
    {
