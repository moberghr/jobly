...
public interface IJobInterceptor
{
    ...
    /// <returns></returns>
    Task JobWillExecuteAsync(JobExecutingContext context, CancellationToken cancellationToken);
...
{
    /// <inheritdoc />
    public virtual Task JobWillExecuteAsync(JobExecutingContext context,
