...
{
    [TimedFact]
    public void WarpEntities_UsePascalCaseTableNames_WhenNoConventionApplied()
    {
        ...
        model.FindEntityType(typeof(Warp.Core.Data.Entities.Worker))!.GetTableName().ShouldBe("Worker");
    ...
    [TimedFact]
    public void WarpEntities_UseSnakeCaseTableNames_WhenSnakeCaseConventionApplied()
    {
        var options = new DbContextOptionsBuilder<TestContext>()
    ...
    [TimedFact]
    public void WarpEntities_UseSnakeCaseColumnNames_WhenSnakeCaseConventionApplied()
    {
        var options = new DbContextOptionsBuilder<TestContext>()
            .UseNpgsql("Host=dummy")
            .UseSnakeCaseNamingConvention()
    ...
    [TimedFact]
    public void WarpEntities_UseDefaultWarpSchema()
    {
        var options = new DbContextOptionsBuilder<TestContext>()
            .UseSqlServer("Server=dummy")
            .Options;
        ...
        model.FindEntityType(typeof(Job))!.GetSchema().ShouldBe("warp");
        model.FindEntityType(typeof(RecurringJob))!.GetSchema().ShouldBe("warp");
        model.FindEntityType(typeof(JobLog))!.GetSchema().ShouldBe("warp");
        model.FindEntityType(typeof(Server))!.GetSchema().ShouldBe("warp");
        model.FindEntityType(typeof(Warp.Core.Data.Entities.Worker))!.GetSchema().ShouldBe("warp");
        model.FindEntityType(typeof(Counter))!.GetSchema().ShouldBe("warp");
    }

    [TimedFact]
    public void WarpEntities_UseCustomSchema_WhenOverridden()
    {
    ...
    [TimedFact]
    public void WarpEntities_UseNullSchema_WhenSetToNull()
    {
