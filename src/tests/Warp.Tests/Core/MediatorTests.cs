...
public class MediatorTests
{
    ...
    public async Task Send_WithRequestHandler_ReturnsResponse()
    {
        ...
        var result = await mediator.Send(new GetGreetingRequest { Name = "Warp" }, Xunit.TestContext.Current.CancellationToken);

        result.ShouldBe("Hello, Warp!");
    }
    ...
    public async Task Send_WithNoHandler_ThrowsInvalidOperationException()
    {
        ...
        await Should.ThrowAsync<InvalidOperationException>(
            () => mediator.Send(new GetGreetingRequest { Name = "Warp" }, Xunit.TestContext.Current.CancellationToken));
    }
    ...
    internal class FailingStreamHandler : IStreamRequestHandler<GetNumbersStreamRequest, int>
    {
